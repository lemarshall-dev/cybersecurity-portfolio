...
## CIA Triad
Top three things to protect
<img width="1140" height="800" alt="image" src="https://github.com/user-attachments/assets/3876b44d-fe6c-442f-b84c-2d27855c2fa3" />
...
Authentication is the process of verifying you are who you say you are. Common examples include:
    -Passwords/Pins/Memorable words
    - Fingerpints/ faceID (Biometrics)
    - Phonenumbers for OTP

### Weak File permissions
Weak file permissions make an attack much simpler. If a file has a weak permission layout, it could allow them to access files. Same with integrity, they may be able to mdify files that they should not be able to. 

### Access to Malicious Programs
Depending on the type of program, it could attach all three of the triad.

A trojan horse is a type of malicious program. They give the attacker access to your system by posing as a trusted file, with hidden malicious programming. 
Ransomeware attacks the Availability side of things byt restriciting your access to your own files via encryption. Unless you know the encryption password, you can't access them. They often offer to decrypt the file for a usually hefty price.
